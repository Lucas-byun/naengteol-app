...
var sel=new Set(),favs=new Set(),tab='cook',mode='ing',cat='자주',searchQ='',detailR=null,fsR=null,servMul=1,fsServMul=1,mealFilter='전체',diffFilter='전체',timeFilter=0,myIngAction='pick';
